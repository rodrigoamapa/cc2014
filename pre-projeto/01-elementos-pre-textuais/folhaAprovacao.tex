...
\begin{folhadeaprovacao}
    ...
    \begin{center}
        Trabalho aprovado. \imprimirlocal, $\qquad$ de $\qquad \qquad$ de 2018.
    \end{center}
	
	\vspace*{20pt}
    \begin{center}
        \assinatura{\textbf{\imprimirorientador} \\ Orientador}
        \assinatura{\textbf{Dr. José Walter Cárdenas Sotil} \\ Universidade Federal do Amapá}
        \assinatura{\textbf{Me. Marco Antônio Leal da Silva} \\ Universidade Federal do Amapá}
