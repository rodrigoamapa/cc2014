...
Já para Jian Huang \textit{Et al}\cite{Huang-et-al-justifica}, O banco de dados HBase é um sistema de armazenamento chave/valor de código livre, então, de fácil acesso, que está sendo usado em \textit{datacenters} de grandes empresas como Facebook e Twitter devido sua portabilidade e escalabilidade massiva.  
...
%Muitos estudiosos no Brasil têm feito pesquisas na área de Segurança Pública, principalmente depois dos últimos anos do século XXI, pois as estatísticas de violência e criminalidade têm aumentado nas cidades brasileiras. Para a professora Moema Freire, da PUC-MG, a segurança no Brasil passou por paradigmas cujas políticas influenciaram no quadro da sensação de segurança que vivemos hoje \cite{Dutra-Freire-2009}.

%Na concepção de Zhang e Ying-cong\cite{Zhang-Ying-justificativa}, o principal desafio na Segurança Pública na China é sua gerência na prevenção e emergência, demandando a utilização dos mais variados recursos urbanos, como a tecnologia computacional, mais especificamente, Internet das Coisas, \textit{Big Data}, telemetria e georreferenciamento de tempo real, o que tornam os meios mais aprimorados. 

%Mais especificamente, em Macapá, de acordo com dados do Fórum Brasileiro de Segurança Pública \cite{forumdeseguranca:2018}, a capital amapaense possui um dos piores cenários com relação à Segurança e os órgãos públicos envolvidos necessitam cada vez mais de investimentos para mudar tal cenário. Um dos investimentos que se pode fazer é na tecnologia computacional para se obter estratégias preventivas no combate ao crime das áreas urbanas. Isso porque, de acordo com o Instituto Brasileiro de Geografia e Estatística, três em cada quatro domicílios do país possuem acesso à internet\cite{IBGE-2018}.
